...
"mootrain" (L<mootrain>) utility to gather frequency
...
by calling:
 ...
 mootm -12 -m morph.gfst -s morph.lab -a -o corpus.mttt corpus.mttt
...
the appropriate incantation is:
 ...
 mootm -m morph.gfst -s morph.lab -a -o test.mt test.t
...
to be tagged, then:
 ...
 moot --model=corpus --use-classes=1 -o test.cmt test.mt
