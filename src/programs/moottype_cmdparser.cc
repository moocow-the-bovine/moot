...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  moocow's HMM part-of-speech tagger: token type classifier.\n");
  printf("\n");
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  /* rcfile handling */
  cmdline_parser_read_rcfile("/etc/moottyperc", args_info, 0);
  cmdline_parser_read_rcfile("~/.moottyperc", args_info, 0);
  /* end rcfile handling */
