...
{
  printf("mooteval (%s %s) by Bryan Jurish <moocow@ling.uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  Output evaluator for moocow's PoS tagger.\n");
  printf("\n");
  ...
  printf("\n");
  printf(" Arguments:\n");
  printf("   FILE1 FILE2  Files to compare.\n");
  ...
  printf("   -1        --eval-first               Evaluate FILE1 vs. baseline FILE2\n");
  printf("   -2        --eval-second              Evaluate FILE2 vs. baseline FILE1\n");
  printf("   -oFILE    --output=FILE              Write output to FILE.\n");
  printf("   -IFORMAT  --input-format=FORMAT      Specify input file formats.\n");
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  args_info->eval_first_given = 0;
  args_info->eval_second_given = 0;
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case '1':	 /* Evaluate FILE1 vs. baseline FILE2 */
          if (args_info->eval_first_given) {
            fprintf(stderr, "%s: `--eval-first' (`-1') option given more than once\n", PROGRAM);
          }
          args_info->eval_first_given++;
         if (args_info->eval_first_given <= 1)
           args_info->eval_first_flag = !(args_info->eval_first_flag);
          break;
        
        case '2':	 /* Evaluate FILE2 vs. baseline FILE1 */
          if (args_info->eval_second_given) {
            fprintf(stderr, "%s: `--eval-second' (`-2') option given more than once\n", PROGRAM);
          }
          args_info->eval_second_given++;
         if (args_info->eval_second_given <= 1)
           args_info->eval_second_flag = !(args_info->eval_second_flag);
          break;
        ...
        /* Print help and exit. */
          ...
          else if (strcmp(olong, "eval-first") == 0) {
            if (args_info->eval_first_given) {
              fprintf(stderr, "%s: `--eval-first' (`-1') option given more than once\n", PROGRAM);
            }
            args_info->eval_first_given++;
          ...
          else if (strcmp(olong, "eval-second") == 0) {
            if (args_info->eval_second_given) {
              fprintf(stderr, "%s: `--eval-second' (`-2') option given more than once\n", PROGRAM);
            }
            args_info->eval_second_given++;
