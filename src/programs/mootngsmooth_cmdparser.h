...
#ifndef mootngsmooth_cmdparser_h
#define mootngsmooth_cmdparser_h
...
struct gengetopt_args_info {
  ...
  char * output_arg;	 /* Specify output n-gram model file (default=stdout). (default=-). */
  char * newtag_arg;	 /* Specify new-tag string (default=@NEW) (default=@NEW). */
  ...
  int newtag_given;	 /* Whether newtag was given */
...
#endif /* __cplusplus */
#endif /* mootngsmooth_cmdparser_h */
