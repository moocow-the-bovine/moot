...
waste [OPTIONS] FILE(s)
 ...
 Options
    ...
    -IFORMAT  --input-format=FORMAT   Specify input file format (for -no-scan)
...
Low-level rule-based scanner stage for moot/WASTE HMM tokenizer.
...
Bryan Jurish E<lt>moocow@cpan.orgE<gt>, Kay-Michael Würzner E<lt>wuerzner@bbaw.deE<gt>
