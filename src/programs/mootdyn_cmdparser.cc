...
{
  printf("mootdyn (%s %s) by Bryan Jurish <moocow@cpan.org>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("             --no-banner                  Suppress initial banner message (implied at verbosity levels <= 2)\n");
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  /* rcfile handling */
  cmdline_parser_read_rcfile("/etc/mootdynrc", args_info, 0);
  cmdline_parser_read_rcfile("~/.mootdynrc", args_info, 0);
  /* end rcfile handling */
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'w':	 /* Specify pseudo-tag for new analyses (default='@NEW') */
          ...
          args_info->dyn_new_tag_given++;
          if (args_info->dyn_new_tag_arg) free(args_info->dyn_new_tag_arg);
        ...
        /* Print help and exit. */
          ...
          /* Suppress initial banner message (implied at verbosity levels <= 2) */
            ...
            if (args_info->no_banner_given) {
              fprintf(stderr, "%s: `--no-banner' option given more than once\n", PROGRAM);
            }
