...
#line 84 "mootClassfreqsLexer.ll"
...
#endif
  ;
 virtual void  YY_mootClassfreqsLexer_FATAL_ERROR(const char *msg)
#ifdef YY_mootClassfreqsLexer_FATAL_ERROR_PURE
  =0
#endif
  ;
