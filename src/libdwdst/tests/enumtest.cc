 ...
 */
typedef dwdstEnum<string, hash<string>, equal_to<string> > stringEnum;

/**
 * almost as intuitive : also requires -ftemplate-depth-NN, NN>=19)
 */
//class stringEnum : public dwdstEnum<string, hash<string>, equal_to<string> > {};
...
typedef dwdstEnum<string, str_hash, str_equal> stringEnum;
*/

/**
 * alternate: bonks
typedef dwdstEnum<string,hash_map<string,dwdstEnumID> > stringEnum;
 */
...
typedef dwdstEnum<string,stringEnumUtils::HashFcn,stringEnumUtils::EqualFcn> stringEnum;
*/
