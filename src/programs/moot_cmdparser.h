...
#ifndef moot_cmdparser_h
#define moot_cmdparser_h
...
struct gengetopt_args_info {
  ...
  int stream_flag;	 /* Use stream-wise I/O routines instead of sentence buffers. (default=0). */
  ...
  int stream_given;	 /* Whether stream was given */
