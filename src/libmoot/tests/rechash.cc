...
/* recursive version */
typedef mootTokString                         LexfreqKey;
typedef mootTagString                         LexfreqSubkey;
...
LexfreqTable t;
mootTokString tok = "foo";
mootTagString tag = "NN";
...
void test_insert(void) {
  ...
  if (sti != ti->second->end()) {
    ...
    sti = ti->second->insert(pair<mootTagString,LexfreqCount>(tag,lfcount)).first;
  }
}
