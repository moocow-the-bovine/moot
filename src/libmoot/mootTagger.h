...
#ifndef _moot_TAGGER_H_
#define _moot_TAGGER_H_
...
//#include "mootDisambiguator.h"

/*--------------------------------------------------------------------------
 * mootTagger : tagger class
 *--------------------------------------------------------------------------*/
...
public:
  ...
  /** constructor */
  mootTagger(FSMSymSpec *mysyms=NULL, FSM *mymorph=NULL);
  /** destructor */
  ~mootTagger();
