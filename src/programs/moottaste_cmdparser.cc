...
{
  printf("moottaste (%s %s) by Bryan Jurish <jurish@uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  moocow's HMM part-of-speech tagger: heuristic token classifier.\n");
  printf("\n");
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  /* rcfile handling */
  cmdline_parser_read_rcfile("/etc/moottasterc", args_info, 0);
  cmdline_parser_read_rcfile("~/.moottasterc", args_info, 0);
  /* end rcfile handling */
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'F':	 /* Use LABEL as the default flavor (default=empty string or from flavor-file). */
          if (args_info->default_flavor_given) {
            fprintf(stderr, "%s: `--default-flavor' (`-F') option given more than once\n", PROGRAM);
          }
          args_info->default_flavor_given++;
          if (args_info->default_flavor_arg) free(args_info->default_flavor_arg);
          args_info->default_flavor_arg = gog_strdup(val);
          break;
        ...
        /* Print help and exit. */
          ...
          else if (strcmp(olong, "default-flavor") == 0) {
            if (args_info->default_flavor_given) {
              fprintf(stderr, "%s: `--default-flavor' (`-F') option given more than once\n", PROGRAM);
            }
            args_info->default_flavor_given++;
