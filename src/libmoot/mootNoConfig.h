/* src/libmoot/mootAutoConfig.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this to enable slow but memory-friendly n-gram hash storage */
