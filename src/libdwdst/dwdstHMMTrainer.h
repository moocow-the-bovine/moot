/* -*- Mode: C++ -*- */
/*--------------------------------------------------------------------------
 * File: dwdstHMMTrainer.h
 * Author: Bryan Jurish <moocow@ling.uni-potsdam.de>
 * Description:
 *   + Trainer for KDWDS HMM PoS-tagger: shared headers
 *--------------------------------------------------------------------------*/

#ifndef _DWDST_HMM_TRAINER_H_
#define _DWDST_HMM_TRAINER_H_
...
/*--------------------------------------------------------------------------
 * dwdstHMMTrainer : HMM trainer class
 *--------------------------------------------------------------------------*/

/// High-level class to gather training data for a dwdstHMM or dwdstCHMM.
class dwdstHMMTrainer {
...
public:
  ...
  //@{
  /** Type for an N-gram */
  typedef dwdstNgrams::NgramString Ngram;

  /** Type for counts */
  typedef dwdstNgrams::NgramCount CountT;

  /** Type for current tag-sets */
  typedef set<dwdstTagString> TagSet;
...
public:
  ...
  //@{
  /** Gather training data from a C-stream using dwdstTaggerLexer */
  bool train_from_stream(FILE *in=stdin, const char *filename="(unknown)");

  /** Gather training data from a file using dwdstTaggerLexer */
  ...
  inline void train_token(const dwdstTokString &curtok, const TagSet &curtags)
  {
