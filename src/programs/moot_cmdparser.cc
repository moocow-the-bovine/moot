...
{
  printf("moot (%s %s) by Bryan Jurish <moocow@cpan.org>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("   -S        --stream                     Use stream-wise I/O routines instead of sentence buffers.\n");
  ...
  printf("             --save-ambiguities           Annotate tagged tokens with lexical ambiguities\n");
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'S':	 /* Use stream-wise I/O routines instead of sentence buffers. */
          if (args_info->stream_given) {
            fprintf(stderr, "%s: `--stream' (`-S') option given more than once\n", PROGRAM);
          }
          args_info->stream_given++;
         if (args_info->stream_given <= 1)
           args_info->stream_flag = !(args_info->stream_flag);
          break;
        ...
        /* Print help and exit. */
          ...
          /* Annotate tagged tokens with lexical ambiguities */
            ...
            if (args_info->save_ambiguities_given) {
              fprintf(stderr, "%s: `--save-ambiguities' option given more than once\n", PROGRAM);
            }
