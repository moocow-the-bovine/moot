...
{
  printf("mootngsmooth (%s %s) by Bryan Jurish <moocow@ling.uni-potsdam.de>\n", PACKAGE, VERSION);
}
...
cmdline_parser_print_help (void)
{
  ...
  printf("\n");
  printf("Purpose:\n");
  printf("  moocow's HMM part-of-speech tagger/disambiguator: n-gram smoother.\n");
  printf("\n");
  
  printf("Usage: %s [OPTIONS]... MODEL.123\n", "mootngsmooth");
  
  printf("\n");
  printf(" Arguments:\n");
  printf("   MODEL.123  Input n-gram model file\n");
  ...
  printf("   -oFILE   --output=FILE     Specify output n-gram model file (default=stdout).\n");
  printf("   -wTAG    --newtag=TAG      Specify new-tag string (default=@NEW)\n");
...
clear_args(struct gengetopt_args_info *args_info)
{
  ...
  args_info->newtag_arg = gog_strdup("@NEW"); 
...
cmdline_parser (int argc, char * const *argv, struct gengetopt_args_info *args_info)
{
  ...
  args_info->newtag_given = 0;
  args_info->verbose_ngrams_given = 0;

  clear_args(args_info);

  /* rcfile handling */
  cmdline_parser_read_rcfile("/etc/mootngsmoothrc", args_info, 0);
  cmdline_parser_read_rcfile("~/.mootngsmoothrc", args_info, 0);
  /* end rcfile handling */
  ...
  switch (oshort)
    {
      case 'h':	 /* Print help and exit. */
        ...
        case 'o':	 /* Specify output n-gram model file (default=stdout). */
        ...
        case 'w':	 /* Specify new-tag string (default=@NEW) */
          if (args_info->newtag_given) {
            fprintf(stderr, "%s: `--newtag' (`-w') option given more than once\n", PROGRAM);
          }
          args_info->newtag_given++;
          if (args_info->newtag_arg) free(args_info->newtag_arg);
          args_info->newtag_arg = gog_strdup(val);
          break;
        ...
        /* Print help and exit. */
          ...
          /* Specify output n-gram model file (default=stdout). */
          ...
          /* Specify new-tag string (default=@NEW) */
          else if (strcmp(olong, "newtag") == 0) {
            if (args_info->newtag_given) {
              fprintf(stderr, "%s: `--newtag' (`-w') option given more than once\n", PROGRAM);
            }
            args_info->newtag_given++;
